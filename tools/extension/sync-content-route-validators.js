...
const sourcePath = path.join(ROOT, 'apps', 'tm-extension', 'src', 'content-route-validators.js');
const targetPath = path.join(ROOT, 'extension', 'content-route-validators.js');
