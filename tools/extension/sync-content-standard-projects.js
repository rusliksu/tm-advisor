...
const sourcePath = path.join(ROOT, 'apps', 'tm-extension', 'src', 'content-standard-projects.js');
const targetPath = path.join(ROOT, 'extension', 'content-standard-projects.js');
