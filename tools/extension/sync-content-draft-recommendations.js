...
const sourcePath = path.join(ROOT, 'apps', 'tm-extension', 'src', 'content-draft-recommendations.js');
const targetPath = path.join(ROOT, 'extension', 'content-draft-recommendations.js');
