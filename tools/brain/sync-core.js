...
const sourcePath = path.join(ROOT, 'packages', 'tm-brain-js', 'src', 'brain-core.js');
const targetPaths = [
  path.join(ROOT, 'extension', 'shared', 'brain-core.js'),
  path.join(ROOT, 'bot', 'shared', 'brain-core.js'),
];
