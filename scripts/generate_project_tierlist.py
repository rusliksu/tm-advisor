...
EXISTING_EVALUATIONS = [
    ...
    {"name": "Colonial Representation", "score": 72, "tier": "B",
     "economy": "Permanent +1 influence plus one-time 3 MC per own colony.",
     "reasoning": "Prelude 2 source includes +1 influence, so this is not a cash-only rebate. No tags or production, but influence makes it a real Turmoil/Colonies card.",
     "synergies": ["Septem Tribus", "Productive Outpost", "Mining Colony"],
     "when_to_pick": "Colonies+Turmoil, especially with colonies already placed or influence pressure."},
