...
UNDERWORLD_PROJECT_OVERRIDES = {
    ...
    'Underground Smuggling Ring': dict(score=57, tier='D', synergies=['Jenson-Boyle & Co', 'Racketeering', 'Gas Trust'],
                                       when='Когда у тебя уже есть underground token и нужен дешёвый точечный добор ресурса, а corruption ещё контролируема. Это всё ещё не сильная карта, но уже не самое дно.',
                                       econ='7+3=10 MC за 1 corruption и 2 одинаковых стандартных ресурса при условии, что underground token уже есть. Скромный payoff, но лучше, чем голая blanket D-оценка.',
                                       reason='Карта остаётся слабой и очень контекстной, но предыдущий рейтинг был чересчур наказан общим corruption penalty. В рабочих crime/underworld руках это хотя бы терпимый filler.'),
