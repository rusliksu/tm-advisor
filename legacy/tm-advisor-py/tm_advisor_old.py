...
# LEGACY NOTICE:
# This monolithic file is kept only as historical reference.
# Canonical advisor runtime now lives in `scripts/tm_advisor/`
# with app-owned entrypoints/tests under `apps/tm-advisor-py/`.
# This file was moved out of `scripts/` on purpose so active code paths do not
# accidentally depend on it again.
