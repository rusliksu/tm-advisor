const TM_MA_DATA = {
  ...
  // Modular milestones (random M/A games)
  'Farmer': { type: 'milestone', map: 'Modular', desc: '5 animal+microbe resources on cards', check: 'bioResources', target: 5 },
  'Fundraiser': { type: 'milestone', map: 'Modular', desc: '12 MC production', check: 'prod', resource: 'megacredits', target: 12 },
  'Geologist': { type: 'milestone', map: 'Modular', desc: '3 tiles on/adjacent to volcanic areas', check: 'volcanic', target: 3 },
  'Hydrologist': { type: 'milestone', map: 'Modular', desc: 'Have placed 4 oceans', check: 'oceansPushed', target: 4 },
  ...
  'Lobbyist': { type: 'milestone', map: 'Modular', desc: 'All 7 delegates in parties', check: 'delegates', target: 7 },
  'Philantropist': { type: 'milestone', map: 'Modular', desc: '5 cards with non-negative VP', check: 'vpCards', target: 5 },
  'Planetologist': { type: 'milestone', map: 'Modular', desc: '2 Earth + 2 Venus + 2 Jovian tags', check: 'planetTags' },
  'Producer': { type: 'milestone', map: 'Modular', desc: 'Combined production total ≥16', check: 'totalProd', target: 16 },
  ...
  'Thawer': { type: 'milestone', map: 'Modular', desc: 'Have raised temperature 5 steps', check: 'tempPushed', target: 5 },
  'Trader': { type: 'milestone', map: 'Modular', desc: '3 different resource types on cards', check: 'resourceTypes', target: 3 },
  'Tycoon10': { type: 'milestone', map: 'Modular', desc: '10 blue+green cards played', check: 'tableau', target: 10 },
  'Terraformer29': { type: 'milestone', map: 'Modular', desc: 'TR ≥ 29', check: 'tr', target: 29 },
  'Forester': { type: 'milestone', map: 'Modular', desc: '3 greenery tiles', check: 'greeneries', target: 3 },
  'Tactician4': { type: 'milestone', map: 'Modular', desc: '4 cards with requirements', check: 'reqCards', target: 4 },
  // Modular awards (random M/A games)
  'Administrator': { type: 'award', map: 'Modular', desc: 'Most event cards played', check: 'events' },
  'Constructor': { type: 'award', map: 'Modular', desc: 'Most building tags', check: 'tags', tag: 'building' },
  'Founder': { type: 'award', map: 'Modular', desc: 'Most cities', check: 'cities' },
  'Highlander': { type: 'award', map: 'Modular', desc: 'Most tiles not adjacent to ocean', check: 'highlandTiles' },
  'Incorporator': { type: 'award', map: 'Modular', desc: 'Most cards in hand', check: 'hand' },
  'Investor': { type: 'award', map: 'Modular', desc: 'Highest total production', check: 'totalProd' },
  'Metropolist': { type: 'award', map: 'Modular', desc: 'Most tiles adjacent to cities', check: 'cityAdjacency' },
  'Mogul': { type: 'award', map: 'Modular', desc: 'Highest MC production', check: 'prod', resource: 'megacredits' },
  'Politician': { type: 'award', map: 'Modular', desc: 'Most delegates in parties', check: 'delegates' },
  'Traveller': { type: 'award', map: 'Modular', desc: 'Most colonies + trade fleets', check: 'coloniesAndFleets' },
};
