...
const TM_SCORING_CONFIG = {
  ...
  milestoneClaimNow: 3,        // эта карта сама добирает milestone
  milestoneClaimHand: 2,       // эта карта + рука добирают milestone
  ...
  racingFar: -2,               // далеко
  awardSwingLead: 3,           // карта переворачивает funded award в лидерство
  awardSwingTie: 2,            // карта дотягивает до ничьей
  awardSwingClose: 1,          // карта подводит на 1 шаг к лидерству
  awardDefendTight: 1,         // карта укрепляет contested lead/tie
  awardDefendWide: 1,          // карта слегка укрепляет уже имеющееся лидерство
  ...
  // ══════════════════════════════════════════════════════════════
  // PER-CARD SCORE CORRECTIONS
  // Ручные коррекции к итоговому бонусу. Применяются ПОСЛЕ всех расчётов.
  // Положительное = карта системно недооценена, отрицательное = переоценена.
  // ══════════════════════════════════════════════════════════════
  SCORE_CORRECTIONS: {
    'Maxwell Base': -4,           // энерг+venus бонусы переоценены без Venus стратегии
  },
};
